...
namespace Eleanorsoft\OrderReturn\Block\Adminhtml\Order\View\Tab;
...
class ReturnTab extends Template implements TabInterface
{
    /**
     * Template
     *
     * @var string
     */
    protected $_template = 'order/view/tab/return.phtml';
    ...
    public function getTabUrl()
    {
        ...
        return $this->getUrl('eleanorsoft_orderReturn/*/returnTab', ['_current' => true]);
    }
}
