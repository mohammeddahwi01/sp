...
define([
    ...
    $.widget('mage.regionUpdater', {
        ...
        _create: function () {
            ...
            $(this.options.regionListId)[0].addEventListener('change', $.proxy(function (e) {
                this.setOption = false;
                this.currentRegionOption = $(e.target).val();
            }, this));

            $(this.options.regionInputId)[0].addEventListener('focusout', $.proxy(function () {
                this.setOption = true;
            }, this));
        },
        ...
        _initCountryElement: function () {
            ...
            if (this.options.isMultipleCountriesAllowed) {
                ...
                this.element[0].addEventListener('change', $.proxy(function (e) {
