...
ob_end_clean();
		...
		if($export_real){ //only include if real export
			...
			if(!$usepcl){
                ...
                $zip->addFile(Framework::$RS_PLUGIN_PATH.'/public/assets/js/jquery.themepunch.tools.js', 'js/jquery.themepunch.tools.js');
                ...
                $pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/js/jquery.themepunch.tools.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'public/assets/js/', PCLZIP_OPT_ADD_PATH, 'js/');
