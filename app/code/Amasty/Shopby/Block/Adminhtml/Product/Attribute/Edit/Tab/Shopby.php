...
class Shopby extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function addCategorySettingFields($fieldsetDisplayProperties, $dependence, $displayModeField)
    {
        ...
        $dependence->addFieldMap(
            ...
            $categoryTreeDepthField->getName(),
            $this->dependencyFieldFactory->create(
                ['fieldData' => ['value' => $categoryTreeDepthFieldValues, 'separator'=>',', 'negative'=>true], 'fieldPrefix' => '']
            )
        )->addFieldDependence(
            $subcategoriesViewField->getName(),
            $displayModeField->getName(),
        ...
        $dependence->addFieldMap(
            ...
            $renderCategoriesLevelField->getName(),
            $this->dependencyFieldFactory->create(
                ['fieldData' => ['value' => (string) \Amasty\Shopby\Model\Source\RenderCategoriesLevel::CURRENT_CATEGORY_CHILDREN, 'negative'=>true], 'fieldPrefix' => '']
            )
        );
    }
