...
class Title
{
    ...
    public function afterToHtml(
        ...
        if (!$this->_scopeConfig->getValue('amshopby_brand/general/product_icon', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) {
            return $html;
        }
        ...
        if ($product instanceof \Magento\Catalog\Model\Product) {
            if ($product->getId()) {
                $brandCode = $this->_scopeConfig->getValue('amshopby_brand/general/attribute_code');
